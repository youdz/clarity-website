...
<div class="row buttons-modal-gfx">
    ...
    <span>
        <img src="assets/images/documentation/buttons/button_modal_1.png" class="img-fluid cozy-sm" alt="Modal with primary button">
        <p>With primary button</p>
        </span>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-4">
    <span>
        <img src="assets/images/documentation/buttons/button_modal_2.png"  class="img-fluid cozy-sm" alt="Modal with primary button">
        <p>With secondary and primary buttons</p>
        </span>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-4">
    <span>
        <img src="assets/images/documentation/buttons/button_modal_3.png"  class="img-fluid cozy-sm" alt="Modal with primary button">
